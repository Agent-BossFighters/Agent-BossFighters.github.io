        ...
        <TableBody>
          {contracts.map((contract) => (
            <TableRow key={contract.id} className="h-[52px] border-b border-gray-800">
              ...
              <TableCell className="text-white">{contract.item}</TableCell>
              <TableCell className="text-white">{contract.id}</TableCell>
              <TableCell className="text-white">{contract.price}</TableCell>
              <TableCell>
